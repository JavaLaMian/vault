...
public class Credit {//6月10日15点31
    ...
    @Column(name = "wages",type = MySqlTypeConstant.VARCHAR,length = 100)//单位
    ...
    @Column(name = "cId",type = MySqlTypeConstant.INT)
    private int cId;

    @Column(name = "funds",type = MySqlTypeConstant.VARCHAR,length = 100)
    private String funds; //公积金

    @Column(name = "positiveIDPhoto",type = MySqlTypeConstant.VARCHAR)
    private String positiveIDPhoto;

    @Column(name = "negativeIDPhoto",type = MySqlTypeConstant.VARCHAR)
